...
const toggleClassName =
  "inline-flex size-9 items-center justify-center rounded-sm border border-hairline-strong bg-background text-foreground transition-colors hover:bg-muted [&_svg]:size-4";
